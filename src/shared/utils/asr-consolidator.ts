...
export function smartConsolidateASRCues(
  ...
  // Only consolidate if both conditions are met:
  // 1. Subtitles are auto-generated (ASR)
  // 2. Content appears fragmented (short segments with short durations)
  // This prevents re-consolidating already-consolidated subtitles
